  ...
  const skills = [
    {
      ...
      items: ["React.js", "TypeScript", "Tailwind CSS", "Next.js","HTML","CSS","JavaSript"],
      ...
      <div className="max-w-[92%] md:max-w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          {skills.map((skill, index) => (
            <div
              key={index}
              className={`p-4 md:p-6 rounded-lg border border-[#3B82F6]/80 ${skill.bgColor} backdrop-blur-sm transition-all duration-300 hover:border-primary/40 hover:shadow-lg animate-fade-in`}
